            ...
            <div class=" main-content-area">
                ...
                <div class="wrap-iten-in-cart">
                    ...
                    <ul class="products-cart">
                        ...
                        <li class="pr-cart-item">
                            ...
                            <div class="price-field produtc-price"><p class="price">{{ $carts->product->name }}</p></div>
                            <div class="quantity">
                                <div class="quantity-input">
                                    <input type="text" readonly name="product-quatity" value="{{ $carts->prod_qty }}" data-max="120" pattern="[0-9]*" >
                                </div>
                            </div>
                            <div class="price-field sub-total"><p class="price">{{ $carts->product->price * $carts->prod_qty }}</p></div>
                            <div class="delete">
                                <a href="{{ url('delete-cart/'.$carts->id) }}" class="btn btn-delete" title="">
                ...
                <div class="summary">
                    <div class="order-summary">
                        ...
                        <p class="summary-info"><span class="title">Subtotal</span><b class="index">Rp. {{ $total }}</b></p>
                        <p class="summary-info"><span class="title">Shipping</span><b class="index">Free Shipping</b></p>
                        <p class="summary-info total-info "><span class="title">Total</span><b class="index">Rp. {{ $total }}</b></p>
                    </div>
            ...
            <div class="container pb-60">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h2>You Dont Have Any Item On Your Carts</h2>
